        ...
        {projects.map((project) => (
          ...
          >
            ...
            <div className="mt-2 flex space-x-4 ">
              <button onClick={() => handleSelectProject(project)} className="bg-green-500 text-black px-4 py-2 rounded-lg hover:bg-green-600 transition-colors" >
                Select
              </button>
              <button onClick={() => onEditProject(project)} className="bg-yellow-500 text-black px-4 py-2 rounded-lg hover:bg-yellow-600 transition-colors">
                Edycja
              </button>
              <button onClick={() => handleDeleteProject(project.id)} className="bg-red-500 text-black px-4 py-2 rounded-lg hover:bg-red-600 transition-colors">
                Usuń
              </button>
            </div>
          </li>
